...
//#define HOST "128.122.151.172"

#define HOST2 "10.0.0.7"
...
public:
    ...
    bool lampText=false,monitorDisplayText=false,speakerText=false;
    ...
    ofxOscSender sender,sender2,sender3;
